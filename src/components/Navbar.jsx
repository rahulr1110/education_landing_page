...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <div className={`${menu ? "translate-x-0":"-translate-x-full"} md-hidden flex flex-col absolute bg-white left-0 top-20 font-medium text-2xl text-center pt-0 pb-4 gap-8 w-full h-fit transition-transform duration-300`}>
      <Link
            to="home"
            spy={true}
            smooth={true}
